...
describe('SupabaseBuilderMcpServer', () => {
      ...
      [
        {
          ...
          "mimeType": "application/json",
          "name": "schema",
          "uriTemplate": "postgres:///schemas/{schema}",
        },
        {
          "description": "Postgres tables, including columns, constraints, and indexes",
          "mimeType": "application/json",
          "name": "tables",
          "uriTemplate": "postgres:///schemas/{schema}/tables",
        },
        {
          "description": "Postgres table, including columns, constraints, and indexes",
          "mimeType": "application/json",
          "name": "table",
          "uriTemplate": "postgres:///schemas/{schema}/tables/{table}",
        },
        {
          "description": "Postgres RLS policies for a table",
          "mimeType": "application/json",
          "name": "policies",
          "uriTemplate": "postgres:///schemas/{schema}/tables/{table}/policies",
        },
        {
          "description": "Postgres RLS policy",
          "mimeType": "application/json",
          "name": "policy",
          "uriTemplate": "postgres:///schemas/{schema}/tables/{table}/policies/{policy}",
        },
        {
          "description": "Postgres triggers",
          "mimeType": "application/json",
          "name": "triggers",
          "uriTemplate": "postgres:///schemas/{schema}/tables/{table}/triggers",
        },
        {
          "description": "Postgres trigger",
          "mimeType": "application/json",
          "name": "trigger",
          "uriTemplate": "postgres:///schemas/{schema}/tables/{table}/triggers/{trigger}",
        },
        {
          "description": "Postgres views",
          "mimeType": "application/json",
          "name": "views",
          "uriTemplate": "postgres:///schemas/{schema}/views",
        },
        {
          "description": "Postgres view",
          "mimeType": "application/json",
          "name": "view",
          "uriTemplate": "postgres:///schemas/{schema}/views/{view}",
        },
        {
          "description": "Postgres materialized views",
          "mimeType": "application/json",
          "name": "materialized-views",
          "uriTemplate": "postgres:///schemas/{schema}/materialized-views",
        },
        {
          "description": "Postgres materialized view",
          "mimeType": "application/json",
          "name": "materialized-view",
          "uriTemplate": "postgres:///schemas/{schema}/materialized-views/{view}",
        },
        {
          "description": "Postgres functions",
          "mimeType": "application/json",
          "name": "functions",
          "uriTemplate": "postgres:///schemas/{schema}/functions",
        },
        {
          "description": "Postgres function",
          "mimeType": "application/json",
          "name": "function",
          "uriTemplate": "postgres:///schemas/{schema}/functions/{func}",
        },
        {
          "description": "Postgres extension",
          "mimeType": "application/json",
          "name": "extension",
          "uriTemplate": "postgres:///extensions/{extension}",
        },
      ]
    `);
  });
  ...
  test('gets all tables in public schema', async () => {
    ...
    const { contents } = await client.readResource({
      uri: 'postgres:///schemas/public/tables',
    });
      ...
      [
        {
          ...
          "uri": "postgres:///schemas/public/tables/todos",
        },
      ]
    `);
  });
  ...
  test('gets rls policies for a table', async () => {
    ...
    const { contents } = await client.readResource({
      uri: 'postgres:///schemas/public/tables/todos/policies',
    });
      ...
      [
        {
          ...
          "uri": "postgres:///schemas/public/tables/todos/policies/Users can delete their own todos",
        },
        {
          "mimeType": "application/json",
          ...
          "uri": "postgres:///schemas/public/tables/todos/policies/Users can update their own todos",
        },
        {
          "mimeType": "application/json",
          ...
          "uri": "postgres:///schemas/public/tables/todos/policies/Users can create their own todos",
        },
        {
          "mimeType": "application/json",
          ...
          "uri": "postgres:///schemas/public/tables/todos/policies/Users can view their own todos",
        },
      ]
    `);
  });
