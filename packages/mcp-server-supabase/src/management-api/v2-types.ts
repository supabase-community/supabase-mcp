...
export interface paths {
  ...
  '/v2/organizations/{slug}/project-creation-rate': {
    ...
    /**
     * Get the rate for creating a project in an organization
     * @description Returns the authoritative rate a new project adds to the organization, together with the context that decided it. A zero amount is authoritative and means the project can be created without an additional charge.
     */
    get: operations['v2-get-project-creation-rate'];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  '/v2/projects/{ref}/branch-creation-rate': {
    ...
    /**
     * Get the rate for creating a branch of a project
     * @description Returns the authoritative rate a new branch of this project adds to its organization, together with the context that decided it. A zero amount is authoritative and means the branch can be created without an additional charge.
     */
    get: operations['v2-get-branch-creation-rate'];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
...
export interface components {
  schemas: {
    ...
    V2BranchCreationRateResponse: {
      data: {
        attributes: {
          /**
           * @description Authoritative rate a new branch adds to the organization. Zero is authoritative and means the branch can be created without an additional charge.
           * @example 0.01344
           */
          amount: number;
          /**
           * @description ISO 4217 currency of the amount.
           * @example USD
           */
          currency: string;
          /**
           * @description Organization the charge lands on.
           * @example my-org
           */
          organization_slug: string;
          /**
           * @description Project the branch would be created under.
           * @example abcdefghijklmnopqrst
           */
          parent_project_ref: string;
          /**
           * @description Plan that decided the amount.
           * @example pro
           */
          plan_id: string;
          /**
           * @description Interval the amount recurs at.
           * @example hourly
           * @enum {string}
           */
    ...
    V2ProjectCreationRateResponse: {
      data: {
        attributes: {
          /**
           * @description Active projects already in the organization. On a paid plan the first one is absorbed by the organization's compute credits, so this decides whether the amount is zero.
           * @example 1
           */
          active_project_count: number;
          /**
           * @description Authoritative rate a new project adds to the organization. Zero is authoritative and means the project can be created without an additional charge.
           * @example 10
           */
          amount: number;
          /**
  ...
  'v2-get-branch-creation-rate': {
    ...
    responses: {
      200: {
        ...
        content: {
          'application/json': components['schemas']['V2BranchCreationRateResponse'];
        };
      };
      /** @description Unauthorized */
      401: {
